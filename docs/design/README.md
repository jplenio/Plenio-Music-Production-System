...
| [yue2-cover-design.md](yue2-cover-design.md) | 1B, **final 4A** | YuE2 Cover path: data flow, lyrics/score precedence, modes, contracts, validation, test matrix |
| [instrumental-strategy.md](instrumental-strategy.md) | 1B, **final 4A** | defense-in-depth instrumental strategy per model, adapter verdict, detectors |
| [score-editor-design.md](score-editor-design.md) | 1B | reusable notation/ABC editor |
...
Status: Phase 1 complete; D-01 … D-09 confirmed by the owner on 2026-09-25 (ADR-0001 … ADR-0009 in `docs/adr`). Phase 2 (Foundation) and Phase 3 (YuE2 Core) implemented. Phase 4A (design gate) complete: the cover and instrumental specifications are final and wait for the owner's authorization of Phase 4B. Spike and study results are recorded in the assumptions register (target-architecture.md §18), yue2-design.md §5.1/§7 and the phase reports in `docs/test-reports/`.
