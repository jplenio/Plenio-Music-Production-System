...
| The writer runs again although you only wanted a new take | the brief's mode is *new song every run*, or an input of the writer changed (brief, writer model, draft seed) | Choose *one song, stop to review* and keep the brief unchanged; the draft seed is fixed by default |
