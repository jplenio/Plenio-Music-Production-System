...
| MP3 | LAME VBR V0 (highest VBR quality; the bit rate follows the music), at most 48 kHz: 88.2/176.4 kHz audio is converted to 44.1 kHz, 96/192 kHz to 48 kHz for the MP3 only | ID3v2.3 (the version Windows and most players and car radios read), same fields; the comment as a COMM frame | embedded (ID3 APIC frame, front cover) | as FLAC |
